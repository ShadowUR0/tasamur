  ...
  return (
    <form onSubmit={handleSubmit} className={classes.bannerBase} noValidate>
      ...
      <div className={classes.bannerDisclaimer}>
        <FormattedMessage
          id='tasamur.email_subscriptions.form.bottom'
          defaultMessage='Get posts in your inbox without creating a Tasamur account. Unsubscribe at any time. For more information, refer to the <a>Privacy Policy</a>.'
